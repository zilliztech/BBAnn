...
# ================================================================================
# DATA_TYPE
INDEX_PATH=/data/BBANN-Indexes/BBANN-deep-1B-32-500-128-3
QUERY_FILE=/data/datasets/deep/query.public.10K.fbin
# RESULT_OUTPUT
RESULT_OUTPUT_PREFIX=/data/answers/BBANN-deep-1B-32-500-128-3/
TRUTH_SET_FILE=/data/datasets/deep/deep-1B-gt
# NPROBE
