...
# ================================================================================
# DATA_TYPE
INDEX_PATH=/data/BBANN-Indexes/msturing-1b-32-500-128-3
QUERY_FILE=/data/datasets/deep/msturing/query.i8bin
# RESULT_OUTPUT
RESULT_OUTPUT_PREFIX=/data/answers/msturing-1b-32-500-128-3/
TRUTH_SET_FILE=/data/datasets/msturing/msturing-1B-gt
# NPROBE
...
echo "Data Type: float for MSTURING"
