...
inline static R L2SqrCommon(const void *pVect1v, const void *pVect2v,
                            const void *qty_ptr) {
  return ::L2sqr<T1, T1, R>((T1 *)pVect1v, (T1 *)pVect2v, *(size_t *)qty_ptr);
}

inline static float L2SqrFloat(const void *pVect1v, const void *pVect2v,
                               const void *qty_ptr) {
...
inline static float L2SqrSIMD16Ext(const void *pVect1v, const void *pVect2v,
                                   const void *qty_ptr) {
  float *pVect1 = (float *)pVect1v;
  float *pVect2 = (float *)pVect2v;
  size_t qty = *((size_t *)qty_ptr);
...
inline static float L2SqrSIMD4Ext(const void *pVect1v, const void *pVect2v,
                                  const void *qty_ptr) {
  float PORTABLE_ALIGN32 TmpRes[8];
  float *pVect1 = (float *)pVect1v;
  float *pVect2 = (float *)pVect2v;
...
inline static float L2SqrSIMD4ExtResiduals(const void *pVect1v,
                                           const void *pVect2v,
                                           const void *qty_ptr) {
  size_t qty = *((size_t *)qty_ptr);
  size_t qty4 = qty >> 2 << 2;
...
inline static float L2SqrSIMD16ExtResiduals(const void *pVect1v,
                                            const void *pVect2v,
                                            const void *qty_ptr) {
  size_t qty = *((size_t *)qty_ptr);
...
public:
  ...
  DISTFUNC<DISTT> get_dist_func() { return fstdistfunc_; }
...
template <> class L2Space<float, float> : public SpaceInterface<float> {
