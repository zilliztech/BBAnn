...
namespace sq_hnswlib {
    ...
    static float
    L2Sqr_float(const void *pVect1v, const void *pVect2v, const void *qty_ptr) {
    ...
    static float
    L2Sqr(const void *pVect1, const void *pVect2, const void *qty_ptr,const float* codes,bool both_codes) {
