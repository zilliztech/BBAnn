...
# ===========================
# CHANGE HERE TO LOCATE JSON
# x_axis = 'num accessed pages'
x_axis = 'n_candidate'
# x_axis = 'nprobe'
y_axis = 'recall'
# ===========================
...
if __name__ == '__main__':
    ...
    plt.legend(loc='upper left', title="%s, top-10" % dataset_name)
    plt.xlabel(x_axis)
    plt.ylabel(y_axis)
    plt.grid(True, linestyle='-.')
    # plt.xticks([0, 0.1, 0.2, 0.3, 0.4])
    # plt.yticks([0.75, 0.8, 0.85])
    plt.savefig(x_axis + "-" + y_axis + "-curve.png")
    plt.close()
